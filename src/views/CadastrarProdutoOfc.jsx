...
//   loja_id: Yup.string().required("Loja_id é obrigatória"),
// });

// const CadastroProdutoOfc = () => {
...
//   // Função para enviar dados do formulário (criar ou editar produto)
...
//     try {
//       const url = editId
//         ? `https://procureaki.onrender.com/produtos/${editId}` // URL para edição
//         : "https://procureaki.onrender.com/produtos"; // URL para criação
...
//       console.log(result);
//       toast.success(editId ? "Produto atualizado com sucesso!" : "Produto salvo com sucesso!");
...
// export default CadastroProdutoOfc;